...
img_file = workpath +"/Imagenes/1.jpg"
    ...
    if hasFrame:
        ...
        if pointsQueue.qsize() > 0:
            ...
            if len(points) > 0:
                ...
                cv2.putText(skeletonFrame, ATTACK_STATE[val], (int((video_width / 2) - (len(ATTACK_STATE[val]) * 5)) , 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (180, 180, 180), 1, cv2.LINE_AA)
                ...
                if val == ATTACK and (time.time() - agresionTime) > Xseconds:
                    mixer.music.play()
