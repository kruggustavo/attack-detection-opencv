...
\pagestyle{fancy}     
\lhead{\tiny Entrenamiento de redes neuronales para la detección en tiempo\\ real de amenazas y agresiones humanas en imágenes secuenciales}
\rhead{\tiny Gustavo Enrique Escobar Krug}
...
\begin{table}[htbp]
	...
	\footnotesize
	\begin{tabular}{rrcc}
		\raisebox{-\totalheight}{\includegraphics[width=0.25\textwidth]{Imagenes/1.png}} &
		\raisebox{-\totalheight}{\includegraphics[width=0.25\textwidth]{Imagenes/2.png}} \\ 
		\multicolumn{2}{c}{Negativo para Amenaza/Agresión} \\
		
		\raisebox{-\totalheight}{\includegraphics[width=0.25\textwidth]{Imagenes/3.png}} &
		\raisebox{-\totalheight}{\includegraphics[width=0.25\textwidth]{Imagenes/4.png}} \\
		\multicolumn{2}{c}{Negativo para Amenaza/Agresión} \\
		
		\raisebox{-\totalheight}{\includegraphics[width=0.25\textwidth]{Imagenes/5.png}} &
		\raisebox{-\totalheight}{\includegraphics[width=0.25\textwidth]{Imagenes/6.png}} \\ 
